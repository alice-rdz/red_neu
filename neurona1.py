...
class neurona(object):
    ...
    def recibir_entrada(self, tam,pesos):
        ...
        archivo.close()
        self.comparar(tam,pesos,entraday,entradas)


    def comparar(self,tam,pesos,entraday,entradas):
        act = self.leer(entradas)
        for y in range(entradas):
            self.comparar(y)           

    def comparar(self,act):
        t = 
        
    def leer(self,entradas):
